    ...
    with get_conn() as conn:
        if msg_id is not None:
            ...
            if row:
                ...
                # NOTE: Do NOT NULL source_channel in delivered_messages here.
                # It must persist until thread close so subsequent admin replies
                # can fall back to it. purge_delivered_source_channel() handles
                # the purge at close time.
            conn.execute(
